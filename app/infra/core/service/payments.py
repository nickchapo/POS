...
class PaymentService:
    ...
    def calculate_total(self, receipt_id: UUID, currency: Currency = Currency.GEL) -> PaymentResponse:
    ...
    def add_payment_to_receipt(self, receipt_id: UUID, request: AddPaymentRequest) -> PaymentResponse:
